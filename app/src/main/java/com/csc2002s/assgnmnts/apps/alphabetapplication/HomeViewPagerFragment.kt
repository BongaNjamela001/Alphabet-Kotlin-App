...
import com.csc2002s.assgnmnts.apps.alphabetapplication.adapters.FAV_PAGE_INDEX
import com.csc2002s.assgnmnts.apps.alphabetapplication.adapters.ALPHABET_LIST_PAGE_INDEX
import com.csc2002s.assgnmnts.apps.alphabetapplication.adapters.AlphabetApplicationPagerAdapter
import com.csc2002s.assgnmnts.apps.alphabetapplication.databinding.FragmentViewPagerBinding
...
class HomeViewPagerFragment : Fragment() {
    ...
    private fun getTabIcon(position: Int): Int {
        return when (position) {
            ...
            ALPHABET_LIST_PAGE_INDEX -> R.drawable.overview_list_selector
