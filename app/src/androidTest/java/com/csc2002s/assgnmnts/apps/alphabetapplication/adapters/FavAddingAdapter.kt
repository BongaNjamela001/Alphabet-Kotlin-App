...
import com.csc2002s.assgmnts.apps.alphabetapplication.databinding.ListItemFavAddingBinding
...
class FavAddingAdapter :
    ...
    class ViewHolder(
        ...
        private fun navigateToPlant(alphabetId: String, view: View) {
            val direction = HomeViewPagerFragmentDirections
                .actionViewPagerFragmentToAlphabetDetailFragment(plantId)
