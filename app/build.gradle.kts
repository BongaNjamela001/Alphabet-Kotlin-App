...
android {
  ...
  defaultConfig {
    applicationId = "com.csc2002s.assgnmnts.apps.alphabetapplication"
    minSdk = libs.versions.minSdk.get().toInt()
    targetSdk = libs.versions.targetSdk.get().toInt()
    testInstrumentationRunner = "com.csc2002s.assgnmnts.apps.alphabetapplication.utilities.MainTestRunner"
    versionCode = 1
    versionName = "0.1.6"
